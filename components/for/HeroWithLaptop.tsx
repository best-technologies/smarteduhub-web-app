    ...
    <section className="relative overflow-hidden bg-white pt-10 pb-32">
      <div className="container mx-auto">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(139, 92, 246, 0.15) 0%, rgba(139, 92, 246, 0.15) 5%, rgba(59, 130, 246, 0.25) 5%, rgba(59, 130, 246, 0.25) 55%, rgba(139, 92, 246, 0.15) 55%, rgba(139, 92, 246, 0.15) 65%, rgba(168, 85, 247, 0.3) 65%, rgba(168, 85, 247, 0.3) 100%)",
          }}
        >
