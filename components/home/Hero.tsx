      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            SmartEdu Hub helps school owners and administrators manage finance,
            digitize operations, boost efficiency and focus on education.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="bg-brand-primary hover:bg-[#4338CA] px-8 py-3">
              Get Started
            </Button>
