...
export const schoolsFAQ: FAQCategory[] = [
  {
  ...
  },
  {
    ...
    questions: [
      {
        id: 4,
        question: "Can I customize the platform for my school's needs?",
        answer:
          "Yes! SmartEduHub offers extensive customization options including branded portals, custom workflows, configurable grading systems, and tailored reports to match your school's unique requirements.",
      },
      {
        id: 5,
